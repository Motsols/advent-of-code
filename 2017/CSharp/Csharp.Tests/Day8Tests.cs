...
namespace Csharp.Tests
{
    public class Day8Tests
    {
        ...
        {
            var day = new Day8();
            Assert.Equal(1, day.Part1(TestInput));
            Assert.Equal(6012, day.Part1(Input));
        }
        ...
        {
            var day = new Day8();
            Assert.Equal(10, day.Part1(TestInput, true));
            Assert.Equal(6369, day.Part1(Input, true));
        }

        private const string TestInput = @"b inc 5 if a > 1
a inc 1 if b < 5
c dec -10 if a >= 1
c inc -20 if c == 10";
