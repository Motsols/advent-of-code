...
namespace Csharp.Tests
{
    public class Day4Tests
    {
        ...
        public void Part1()
        {
            ...
            Assert.Equal(1, day.Part1("aa bb cc dd ee"));
            Assert.Equal(0, day.Part1("aa bb cc dd aa"));
            Assert.Equal(1, day.Part1("aa bb cc dd aaa"));
            Assert.Equal(455, day.Part1(input));
        }
        ...
        public void Part2()
        {
            ...
            Assert.Equal(1, day.Part2("abcde fghij"));
            Assert.Equal(0, day.Part2("abcde xyz ecdab"));
            Assert.Equal(1, day.Part2("a ab abc abd abf abj"));
            Assert.Equal(1, day.Part2("iiii oiii ooii oooi oooo"));
            Assert.Equal(0, day.Part2("oiii ioii iioi iiio"));
            Assert.Equal(186, day.Part2(input));
        }

        public const string input = @"bdwdjjo avricm cjbmj ran lmfsom ivsof
