...
namespace Csharp.Tests
{
    public class Day7Tests
    {
        ...
        {
            var day = new Day7();
            Assert.Equal("tknk", day.Part1(testInput));
            Assert.Equal("fbgguv", day.Part1(input));
        }
        ...
        {
            var day = new Day7();
            Assert.Equal(60, day.Part2(testInput, "tknk"));
            Assert.Equal(1864, day.Part2(input, "fbgguv"));
        }
...
cntj (57)";
        ...
        public const string input = @"xsddbi (61)
nqtowev (11)
xwohr (82)
flejt (36)
idwpug (54)
